...
def _main():
    """
    Main entry point for the `ppt` command line script.

    We init logging here instead of in ppt.cmdline.main(...) because the latter
    can be called by projects using ppt, and it's bad practice for libraries to
